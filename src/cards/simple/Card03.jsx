...
function Card03() {
  ...
  return (
    <div className="w-[280px] h-fit flex flex-col bg-[#FFFFFF] shadow-[0px_0px_14px_-1px_rgba(0,_0,_0,_0.15)] rounded-xl overflow-hidden p-2">
      <div className="w-full h-[145px] rounded-lg overflow-hidden">
        <img src={Image} alt="" className="w-full h-full object-cover" />
      </div>
      <div className="w-full h-full flex flex-col px-1 pb-1 pt-3">
        {/* first heading */}
