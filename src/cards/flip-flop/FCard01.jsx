...
export default function FCard01() {
  ...
  return (
    <div className="w-[280px] h-fit flex flex-col bg-[#FFFFFF] shadow-[0px_0px_14px_-1px_rgba(0,_0,_0,_0.15)] rounded-xl overflow-hidden">
      <div className="m-2">
        ...
        <div className="w-full h-full flex flex-col pt-[8px] pb-2">
          {/* first heading */}
          ...
          <div className="mt-2">
            <p className="text-[#555555] text-sm">
              Experience a cliffside loft with iconic white walls, blue domes
              and magical sunset views.
            </p>
          </div>
